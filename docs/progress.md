...
最終更新: 2026-08-25  
ステータス: **B5 完了。次は B6（companies / profiles + Auth トリガー）。**
...
**次にやる推奨: B6。** DEC-01（React/Lit）はビューアまで確定しなくてよい。
...
- Prisma 導入済み。enum、`master_*` 定義、B3〜B5 seed（地域・用途・モデル・建具・ガラス・断熱・方位・部位・断熱方法）
